...
class plano(models.Model):
    ...
    necessidades = models.CharField(max_length=100, blank=True)
    requisitos_LDPA = models.CharField(max_length=100, blank=True)
    solucoes_impactadas = models.CharField(max_length=100, blank=True)
    anexo_contexto = models.FileField(upload_to='files', max_length=255, blank=True)
    telas_sistema = models.FileField(upload_to='files', max_length=255, blank=True)
    cronograma_implantacao = models.FileField(upload_to='files', max_length=255, blank=True)
